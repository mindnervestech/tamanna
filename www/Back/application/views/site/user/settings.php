	...
	<div class="container set_area">
		...
		<div class="section profile">
			...
			<fieldset class="frm">
				...
				<input id="loc" class="setting_location" name="setting-location" value="<?php echo $userDetails->row()->location;?>"" class="text" placeholder="<?php if($this->lang->line('settings_eg_new') != '') { echo stripslashes($this->lang->line('settings_eg_new')); } else echo "e.g. Mumbai"; ?>" type="text">
