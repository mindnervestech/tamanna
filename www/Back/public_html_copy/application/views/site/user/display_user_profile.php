         ...
         <?php 
          ...
          ?>
           ...
           <!--   <h3><?php if($this->lang->line('display_featured_find') != '') { echo stripslashes($this->lang->line('display_featured_find')); } else echo "FEATURED FIND"; ?></h3>-->
              <!--<em class="figure-detail"> <span class="username"><em>by <a href="<?php if ($featureProductDetails->row()->username == ''){echo 'user/administrator';}else {echo 'user/'.$featureProductDetails->row()->user_name;}?>"><?php if ($featureProductDetails->row()->user_name == ''){echo 'administrator';}else {echo $featureProductDetails->row()->full_name;}?></a></em></span> </em> -->
          ...
          ?>
            <li class="big clear">
              ...
              <a href="<?php echo 'things/'.$productLikeDetailsRow->id.'/'.url_title($productLikeDetailsRow->product_name);?>" class="figure-img" style="border-bottom:0"> 
            ...
            <!--   <em class="figure-detail"> 
             <span class="username"><em>by <a href="<?php if ($productLikeDetailsRow->user_name == ''){echo 'user/administrator';}else {echo 'user/'.$productLikeDetailsRow->user_name;}?>"><?php if ($productLikeDetailsRow->user_name == ''){echo 'administrator';}else {echo $productLikeDetailsRow->full_name;}?></a></em></span>
              </em> -->
                <ul class="function">
          ...
          ?>
            <li class="big clear">
              ...
              <a href="<?php echo 'user/'.$productLikeDetailsRow->user_name.'/things/'.$productLikeDetailsRow->seller_product_id.'/'.url_title($productLikeDetailsRow->product_name);?>" class="figure-img" style="border-bottom:0"> 
              <span class="figure grid" style="background-size: cover" data-ori-url="images/product/<?php echo $imgName;?>" data-310-url="images/product/<?php echo $imgName;?>"><em class="back"></em>
              </span> 
              <span class="figure classic"> <em class="back"></em> 
              <img src="images/product/<?php echo $imgName;?>" data-width="640" data-height="640"> 
