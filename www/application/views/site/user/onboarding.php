...
<div class="popup onboarding animated" style="margin:139px auto 7px; display: block; opacity: 1;">
	...
	<div style="padding: 47.5px 0px;" class="index">
		...
		<button class="btns-blue-embo btn-close"><?php if($this->lang->line('onboarding_get_stat') != '') { echo stripslashes($this->lang->line('onboarding_get_stat')); } else echo "Get Started"; ?></button></p>
	</div>
</div>
</div>
