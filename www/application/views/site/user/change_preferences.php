	...
	<div class="container set_area">
		...
		<div class="section privacy">
			...
			<fieldset class="frm">
				...
				<label class="label" for="visibility2"><i class="icon-lock-filled"></i> <?php if($this->lang->line('prference_onlyu') != '') { echo stripslashes($this->lang->line('prference_onlyu')); } else echo "Only you"; ?></label>
			</fieldset>
		</div>
