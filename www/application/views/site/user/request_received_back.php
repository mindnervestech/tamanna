...
<div class="popup onboarding animated" style="margin:139px auto 7px; display: block; opacity: 1;">
	...
	<div style="padding: 47.5px 0px;" class="index">
		<p><b><?php echo "Request Submitted"; ?></b></p>
		<p style="width:90%;padding-left: 5%;padding-bottom: 50px;"><?php echo "Thanks for submitting customization request. We will revert back to you shorty with quotation and tentative delivery date."; ?></p>
		<p><!--<span class="bg"></span>-->
		<button class="btns-blue-embo btn-close"><?php echo "OK"; ?></button></p>
	</div>
</div>
</div>
...
*/               
   ...
   //                         arrange();
	...
	$('.popup.onboarding .index .btn-close').click(function(){
	    location.href = baseURL+"shopby/all";
	});
