        ...
        <div class="wrapper timeline normal">
          ...
          ?>
            <li class="big clear">
              ...
              <span class="username"><em>by <a href="<?php if ($productLikeDetailsRow->user_name == ''){echo 'user/administrator';}else {echo 'user/'.$productLikeDetailsRow->user_name;}?>"><?php if ($productLikeDetailsRow->user_name == ''){echo 'administrator';}else {echo $productLikeDetailsRow->full_name;}?></a> + <?php echo $productLikeDetailsRow->likes;?></em></span> 
              </em>
                <ul class="function">
