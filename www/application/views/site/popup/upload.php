...
<div class="popup add-fancy box-rnd-shadow-2 ly-title step1 animated" style="margin-top: 43px; margin-left: 415px; opacity: 1; display: none;overflow: hidden;">
	...
	<div class="step step1">
		...
		<ul class="case">
 			<li><a href="#step2"><?php if($this->lang->line('from_web') != '') { echo stripslashes($this->lang->line('from_web')); } else echo "From Web"; ?></a></li> 
			<li><a href="#step2-upload"><?php if($this->lang->line('header_upload') != '') { echo stripslashes($this->lang->line('header_upload')); } else echo "Upload"; ?></a></li>
		...
		<dl>
			...
			<dd>
				...
				<div class="frm">
					...
					<label><?php if($this->lang->line('header_title') != '') { echo stripslashes($this->lang->line('header_title')); } else echo "Title"; ?><span style="color:red"> *</span></label>
