<div class="popup ly-title gift-recommend" style="display:none;">
	<p class="ltit"><?php if($this->lang->line('header_gift_recom') != '') { echo stripslashes($this->lang->line('header_gift_recom')); } else echo "Gift Recommendations"; ?></p>
	<dl>
...
<p>Delivering in Mumbai, Pune, Delhi, Noida, Gurgaon, Chennai, Bangalore, Hyderabad, Ahmedabad, Surat, Goa, Jaipur, Jodhpur, Kerala, Kochi, Mysore, Madurai, Nagpur, Nasik, Vadodara, Vijayawada and many more locations in India</p>
	<div class="btn-area">
