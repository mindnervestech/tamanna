...
<div class="wrapper-content order" >
  <div id="content" style="padding:0px 20px 20px 20px;">
    <ol class="cart-order-depth">
      <li class="depth1"><span>1</span>
        <?php if($this->lang->line('cart_shop_cart') != '') { echo stripslashes($this->lang->line('cart_shop_cart')); } else echo "Shopping Cart"; ?>
      </li>
      <li class="depth2 current"><span>2</span>
        <?php if($this->lang->line('cart_pay_mthd') != '') { echo stripslashes($this->lang->line('cart_pay_mthd')); } else echo "Payment Method"; ?>
      </li>
      <li class="depth3"><span>3</span>
        <?php if($this->lang->line('cart_ord_confirm') != '') { echo stripslashes($this->lang->line('cart_ord_confirm')); } else echo "Order Confirmation"; ?>
      </li>
    </ol>
      ...
      <div class="cart-payment-wrap card-payment new-card-payment" id="PaypalPay" style="display:<?php if ($paypal_ipn_settings['status'] == 'Enable'){echo 'block';}else {echo 'none';}?>;"> 
        ...
        <form name="PaymentPaypalForm" id="PaymentPaypalForm" method="post" enctype="multipart/form-data" action="site/checkout/PaymentProcess"  autocomplete="off">
          ...
          <div id="complete-payment">
            <div class="hotel-booking-left">
              <dl class="payment-personal">
                <dt><b>
                  ...
                  <?php if($this->lang->line('checkout_enter_bill') != '') { echo stripslashes($this->lang->line('checkout_enter_bill')); } else echo "Enter your billing address"; ?>
                  </small></dt>
                <dd>
                  <label for="payment-personal-name-fst">
                    <?php if($this->lang->line('header_name') != '') { echo stripslashes($this->lang->line('header_name')); } else echo "Name"; ?>
                    <b>*</b></label>
              ...
              <div class="hotel-booking-noti"><big>
                ...
                <?php if($this->lang->line('checkout_ssl') != '') { echo stripslashes($this->lang->line('checkout_ssl')); } else echo "SSL Encrypted transaction powered by"; ?>
                <?php echo $siteTitle;?></div>
            </div>
                ...
                <dd>
                  <ul>
                    <li class="first"> <span class="order-payment-type">
                      ...
                      </span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkAmt[0],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                    <li> <span class="order-payment-type">
                      ...
                      </span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkAmt[1],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                    <li> <span class="order-payment-type">
                      <?php if($this->lang->line('checkout_tax') != '') { echo stripslashes($this->lang->line('checkout_tax')); } else echo "Tax"; ?>
                      </span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkAmt[2],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                    <?php if($checkAmt[5] > 0){ ?>
                    <li> <span class="order-payment-type">
                      <?php if($this->lang->line('checkout_discount') != '') { echo stripslashes($this->lang->line('checkout_discount')); } else echo "Discount"; ?>
                      </span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkAmt[5],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                    <?php }else{  } ?>
                    <li class="total"> <span class="order-payment-type"><b>
                      ...
                      </b></span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkAmt[3],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                  </ul>
                </dd>
              </dl>
            </div>
            ...
            <div class="waiting">
              <?php if($this->lang->line('checkout_processing') != '') { echo stripslashes($this->lang->line('checkout_processing')); } else echo "Processing"; ?>
              ...</div>
          ...
          <div id="complete-payment">
            <div class="hotel-booking-left">
              <dl class="payment-personal">
                ...
                <dd class="comment"><b>*</b> =
                  <?php if($this->lang->line('checkout_mand_fields') != '') { echo stripslashes($this->lang->line('checkout_mand_fields')); } else echo "Mandatory fields"; ?>
                </dd>
                <dd>
                  <label for="payment-personal-name-fst">
                    <?php if($this->lang->line('header_name') != '') { echo stripslashes($this->lang->line('header_name')); } else echo "Name"; ?>
                ...
                <dd>
                  ...
                  <p class="error">
                    <?php if($this->lang->line('checkout_enter_cardno') != '') { echo stripslashes($this->lang->line('checkout_enter_cardno')); } else echo "Please enter valid card number"; ?>
                    .</p>
                </dd>
                <dd>
                  <label for="payment-card-number">
                  ...
                  <select id="cardType" name="cardType" class="select-round select-white select-country selectBox required">
                    <option value="Amex">
                    <?php if($this->lang->line('american_express') != '') { echo stripslashes($this->lang->line('american_express')); } else echo "American Express"; ?>
                    </option>
                    <option value="Visa">
                    <?php if($this->lang->line('visa') != '') { echo stripslashes($this->lang->line('visa')); } else echo "Visa"; ?>
                    </option>
                    <option value="MasterCard">
                    <?php if($this->lang->line('master_card') != '') { echo stripslashes($this->lang->line('master_card')); } else echo "Master Card"; ?>
                    </option>
                    <option value="Discover">
                    <?php if($this->lang->line('discover') != '') { echo stripslashes($this->lang->line('discover')); } else echo "Discover"; ?>
                    </option>
                  </select>
                  <p class="error">
                    <?php if($this->lang->line('checkout_select_card') != '') { echo stripslashes($this->lang->line('checkout_select_card')); } else echo "Please select card"; ?>
                    .</p>
                </dd>
                <dd>
                ...
                <dd>
                  ...
                  <a href="#" class="tooltip" onClick="$('.card-back').show();return false;">
                  <?php if($this->lang->line('checkout_what_this') != '') { echo stripslashes($this->lang->line('checkout_what_this')); } else echo "What is this?"; ?>
                  </a>
                  <p class="error">
                    <?php if($this->lang->line('checkout_enter_sc') != '') { echo stripslashes($this->lang->line('checkout_enter_sc')); } else echo "Please enter security code"; ?>
                    .</p>
                  <dl class="card-back">
                    <dt>
                    ...
                    <dd> <img src="images/card-back.gif" alt="">
                      <?php if($this->lang->line('checkout_last_three') != '') { echo stripslashes($this->lang->line('checkout_last_three')); } else echo "Last three digits on the back of your card is the CVC or CVV number"; ?>
                      .<br>
                      &nbsp;<br>
                      <?php if($this->lang->line('checkout_for_ameri') != '') { echo stripslashes($this->lang->line('checkout_for_ameri')); } else echo "For American Express there is a four digit code on the front"; ?>
              ...
              <dl class="payment-card">
                <dt><b>
                  ...
                  <?php if($this->lang->line('checkout_billing_enter') != '') { echo stripslashes($this->lang->line('checkout_billing_enter')); } else echo "Enter your billing and shipping address"; ?>
                  </small></dt>
                <dd>
                  <label for="payment-adds-1">
                    <?php if($this->lang->line('shipping_address_comm') != '') { echo stripslashes($this->lang->line('shipping_address_comm')); } else echo "Address"; ?>
...
$("#transactionForm").submit();
			 ...
			 <input type="hidden" name="paypalmode" id="paypalmode" value="<?php echo $paypalProcess['mode']; ?>"  />
	            	...
	            	<!--	<img src="http://sandbox.citruspay.com/images/logo.png"/> -->
                        ...
                        <p style="text-align:center;padding-top:40px;font-size:17px;"><b>Redirecting to our payment partner's site...... </b></p>
                        <p style="text-align:center;font-size:15px;"><b>Please Wait for a second!!.....</b></p>
        ...
        <form name="PaymentPaypalForm" id="PaymentPaypalForm" method="post" enctype="multipart/form-data" action="site/checkout/PaymentGiftFree" autocomplete="off">
          <div id="complete-payment">
            ...
            <div class="cart-payment">
              <dl class="cart-payment-order">
                <dt>
                  <?php if($this->lang->line('checkout_ur_used_gc') != '') { echo stripslashes($this->lang->line('checkout_ur_used_gc')); } else echo "You are used Gift Cart"; ?>
                </dt>
                <dd>
                  <ul>
                    <li class="total"> <span class="order-payment-type"><b>
              ...
              <dl class="cart-payment-order">
                ...
                <dd>
                  <ul>
                    <li class="first"> <span class="order-payment-type">
                      <?php if($this->lang->line('checkout_item_total') != '') { echo stripslashes($this->lang->line('checkout_item_total')); } else echo "Item total"; ?>
                      </span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($GiftViewTotal,2,'.',''); ?></b> <?php echo $$currencyType;?></span> </li>
                    <li class="total"> <span class="order-payment-type"><b>
                      <?php if($this->lang->line('purchases_total') != '') { echo stripslashes($this->lang->line('purchases_total')); } else echo "Total"; ?>
                      </b></span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($GiftViewTotal,2,'.',''); ?></b> <?php echo $$currencyType;?></span> </li>
                  </ul>
                </dd>
              </dl>
            </div>
              ...
              <dl class="cart-payment-order">
                ...
                <dd>
                  <ul>
                    <li class="first"> <span class="order-payment-type">
                      <?php if($this->lang->line('checkout_item_total') != '') { echo stripslashes($this->lang->line('checkout_item_total')); } else echo "Item total"; ?>
                      </span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkSub[0],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                    <li> <span class="order-payment-type">
                      <?php if($this->lang->line('referrals_shipping') != '') { echo stripslashes($this->lang->line('referrals_shipping')); } else echo "Shipping"; ?>
                      </span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkSub[1],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                    <li> <span class="order-payment-type">
                      <?php if($this->lang->line('checkout_tax') != '') { echo stripslashes($this->lang->line('checkout_tax')); } else echo "Tax"; ?>
                      </span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkSub[2],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                    <li class="total"> <span class="order-payment-type"><b>
                      <?php if($this->lang->line('purchases_total') != '') { echo stripslashes($this->lang->line('purchases_total')); } else echo "Total"; ?>
                      </b></span> <span class="order-payment-usd"><b><?php echo $currencySymbol;?><?php echo number_format($checkSub[3],2,'.',''); ?></b> <?php echo $currencyType;?></span> </li>
                  </ul>
                </dd>
              </dl>
            </div>
...
<!-- Google Code for Furniture Conversion Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 986307802;
var google_conversion_language = "en";
var google_conversion_format = "3";
var google_conversion_color = "ffffff";
var google_conversion_label = "_Tb1CO_65FcQ2rmn1gM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/986307802/?label=_Tb1CO_65FcQ2rmn1gM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
<!-- Adwords Conversion Tracking Code Ends-->
</body>
</html>