...
?>                    
		...
		<fieldset class="frm">
			...
			<input type="password" id="password" name="password" placeholder="" /></p>
                    ...
                    <a style="float:right;"href="forgot-password"><?php if($this->lang->line('forgot_passsword') != '') { echo stripslashes($this->lang->line('forgot_passsword')); } else echo "Forgot Password"; ?>?</a>
...
<p style="padding-top: 10px;">Do not have an account?<a href="/signup"> Register Now</a></p>
	</div>
