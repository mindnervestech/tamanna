			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open_multipart('admin/product/insertEditAffiliateProduct',$attributes) ;
						...
						<ul>
							...
							<div class="form_input">
	 						...
	 						<li>
								...
								<div class="form_input">
								<textarea name="excerpt" id="excerpt" tabindex="3" style="width:370px;" class="large tipTop mceEditor" title="Please enter the product Excerpt"><?php echo $product_details->row()->excerpt;?></textarea>
								</div>
								</div>
							</li>
							...
							<li>
								<div class="form_grid_12">
								<label class="field_title" for="description"><?php if($this->lang->line('product_additional_description') != '') { echo stripslashes($this->lang->line('product_additional_description')); } else echo "Additional Information"; ?></label>
                                            <div class="form_input">
                                            <textarea name="additional_description" id="additional_description" tabindex="4" style="width:370px;" class="large tipTop mceEditor" title="Please enter the Additional Description"><?php echo $product_details->row()->additional_description;?></textarea>                                            
</div>
								</div>
							</li>
