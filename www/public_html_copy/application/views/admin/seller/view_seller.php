				...
				<div class="widget_wrap">
					...
					<div id="tab1">
	 						<ul>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title" for="admin_name">Phone</label>
									<div class="form_input">
										<?php echo $seller_details->row()->s_phone_no;?>
									</div>
								</div>
								</li>
<li>
								<div class="form_grid_12">
									<label class="field_title" for="admin_name">TIN No.</label>
									<div class="form_input">
										<?php 
										if ($seller_details->row()->s_tin_no == ''){
											echo 'Not available';
										}else {
											echo $seller_details->row()->s_tin_no;
										}
										?>
									</div>
								</div>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title" for="admin_name">VAT No.</label>
									<div class="form_input"><?php 
										if ($seller_details->row()->s_vat_no == ''){
											echo 'Not available';
										}else {
											echo $seller_details->row()->s_vat_no;
										}
										?>
									</div>
								</div>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title" for="admin_name">CST No.</label>
									<div class="form_input"><?php 
										if ($seller_details->row()->s_cst_no == ''){
											echo 'Not available';
										}else {
											echo $seller_details->row()->s_cst_no;
										}
										?>
									</div>
								</div>
